...
// Types imports
import { UserTableCellProps } from "../../../types/propTypes";
// Third-party imports
 ...
 *
 * @param {UserTableCellProps} props - The props containing the cell type and value.
 * @returns {ReactElement} A React element representing the custom table cell.
 */
export function CustomTableCell({ type, value }: UserTableCellProps): ReactElement {
    return (
